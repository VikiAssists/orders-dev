...
import 'package:orders_dev/Screens/bill_print_screen_8.dart';
...
class ItemsInEachOrderRunningOrder extends StatefulWidget {
...
//AndInputToThisClass
  ...
  const ItemsInEachOrderRunningOrder(
      {Key? key,
  ...
  @override
  State<ItemsInEachOrderRunningOrder> createState() =>
      _ItemsInEachOrderRunningOrderState();
}

class _ItemsInEachOrderRunningOrderState
    extends State<ItemsInEachOrderRunningOrder> with WidgetsBindingObserver {
...
//First,StoringThatATableWithAAsThoughItWasSplit
                              ...
                              tempMasterUpdaterMap.addAll({
                                'itemsInOrderMap': alreadyPresentOrderToBeMoved[
                                    'itemsInOrderMap']
                              });
                              tempMasterUpdaterMap.addAll({
                                'statusMap':
...
//ItShouldBeEnsured,ItIsMovedAsAParentToTheNoOneOccupiedTable
                            ...
                            tempSecondMasterUpdaterMap
                                .addAll({'partOfTableOrParcel': 'Table'});
                            tempSecondMasterUpdaterMap.addAll({
                              'partOfTableOrParcelNumber': tableOrParcelToMoveTo
                            });
...
//ItShouldBeEnsured,ItIsMovedAsAParentToTheNoOneOccupiedTable
    ...
    void splitTableOrParcel() async {
      ...
      if (parentOrChild == 'parent') {
        ...
        tempSecondMasterUpdaterMap.addAll({'ticketsMap': ticketsFromServerMap});
        tempSecondMasterUpdaterMap
        ...
        FireStoreDeleteFinishedOrderInRunningOrders(
                hotelName: widget.hotelName, eachItemId: widget.itemsFromDoc)
            .deleteFinishedOrder();
      } else {
        // int count = 0;
    ...
    void deliveredAllAlertDialogBox() async {
      showDialog(
        ...
        builder: (BuildContext context) => AlertDialog(
          ...
          content: Text('Press Yes if all items are delivered'),
          actions: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
...
//deletingAnNonAcceptedItemFromTheListOfItems
...
//ListTileWillHaveItemNameInLeftAndNumberInRight
                                  ...
                                  Padding(
                                    ...
                                    child: BottomButton(
                                        ...
                                        buttonColor:
                                            (deliveredStatus && !noItemsInTable)
...
//Initially,WeWillHaveTheOtherListsEmpty
                                            List<String> distinctItems = widget
                                                .itemsName
                                                .toSet()
                                                .toList();
                                            ...
                                            Map<String, String> printOrdersMap =
                                                HashMap();
...
//AndPriceOfEachItemIsNoted
                                              for (int i = 0;
                                                ...
                                                if (distinctItem ==
                                                  ...
                                                  numberOfItems =
                                                      numberOfItems +
                                                          widget.itemsNumber[i];
                                                  priceOfEachItem =
                                                      widget.itemsEachPrice[i];
                                                }
                                              }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => MenuPageWithRunningOrdersChange(
                        ...
                        alreadyRunningTicketsMap: ticketsFromServerMap,
                      ),
                    ),
                  );
                },
