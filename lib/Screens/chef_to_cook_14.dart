...
class ChefToCookWithRejectionRegistering extends StatefulWidget {
  ...
  @override
  State<ChefToCookWithRejectionRegistering> createState() =>
      _ChefToCookWithRejectionRegisteringState();
}
...
class _ChefToCookWithRejectionRegisteringState
    extends State<ChefToCookWithRejectionRegistering>
...
//ToShowThatHeHasAcceptedTheOrder
    ...
    if (newStatusToUpdate == 11) {
//ThisIsToEnsureWhenTheCaptainDeletesTheItem,WeHaveRejectedChefName&PhoneNumber
      tempMapToUpdateStatus.addAll({
        'rejectingChefName': json.decode(
                Provider.of<PrinterAndOtherDetailsProvider>(context,
                        listen: false)
                    .allUserProfilesFromClass)[
            Provider.of<PrinterAndOtherDetailsProvider>(context, listen: false)
