...
class ItemsWithCancelAccessCheck extends StatefulWidget {
...
//AndInputToThisClass
  ...
  const ItemsWithCancelAccessCheck(
      {Key? key,
  ...
  @override
  State<ItemsWithCancelAccessCheck> createState() =>
      _ItemsWithCancelAccessCheckState();
}

class _ItemsWithCancelAccessCheckState extends State<ItemsWithCancelAccessCheck>
...
//IfThereIsOnlyOneItemWeDeleteTheTableItself
                                                                          FireStoreDeleteFinishedOrderInRunningOrders(hotelName: widget.hotelName, eachTableId: itemBelongsToDoc)
                                                                              .deleteFinishedOrder();
                                                                          Navigator.pop(
                                                                              context);
                                                                        } else if (itemStatus ==
...
//letTheStatusOfCaptainCancelledItemBe12
                                                                          ...
                                                                          FireStoreAddOrderInRunningOrderFolder(hotelName: widget.hotelName, seatingNumber: itemBelongsToDoc, ordersMap: masterOrderMapToServer)
                                                                              .addOrder();
