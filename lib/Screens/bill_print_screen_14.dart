...
class BillPrintWithExtraNetCheckAtPaymentDone extends StatefulWidget {
  final String hotelName;
  // final String addedItemsSet;
  final List<String> itemsID;
  final String itemsFromThisDocumentInFirebaseDoc;

  const BillPrintWithExtraNetCheckAtPaymentDone({
    Key? key,
  ...
  @override
  State<BillPrintWithExtraNetCheckAtPaymentDone> createState() =>
      _BillPrintWithExtraNetCheckAtPaymentDoneState();
}

class _BillPrintWithExtraNetCheckAtPaymentDoneState
    extends State<BillPrintWithExtraNetCheckAtPaymentDone> {
