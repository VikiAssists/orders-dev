...
class RestaurantBaseInfoWithFooter extends StatefulWidget {
  final String hotelName;
  const RestaurantBaseInfoWithFooter({Key? key, required this.hotelName})
      : super(key: key);

  @override
  State<RestaurantBaseInfoWithFooter> createState() =>
      _RestaurantBaseInfoWithFooterState();
}

class _RestaurantBaseInfoWithFooterState
    extends State<RestaurantBaseInfoWithFooter> {
