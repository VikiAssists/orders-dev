...
class ChefToCookPrintAlignment extends StatefulWidget {
  ...
  ChefToCookPrintAlignment(
      {Key? key, required this.hotelName, required this.chefSpecialities})
      : super(key: key);

  @override
  State<ChefToCookPrintAlignment> createState() =>
      _ChefToCookPrintAlignmentState();
}
...
class _ChefToCookPrintAlignmentState extends State<ChefToCookPrintAlignment>
