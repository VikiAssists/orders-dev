...
class OrderHistoryWithNewPrintPackage extends StatefulWidget {
  //ScreenWhereWeShowTheBillsTillNow
  final String hotelName;

  const OrderHistoryWithNewPrintPackage({Key? key, required this.hotelName})
      : super(key: key);

  @override
  State<OrderHistoryWithNewPrintPackage> createState() =>
      _OrderHistoryWithNewPrintPackageState();
}

class _OrderHistoryWithNewPrintPackageState
    extends State<OrderHistoryWithNewPrintPackage> {
...
//CurrentlyNotCaringWhether58mmOr80mm.WillChangeLater
    ...
    if (localhotelNameForPrint != '') {
      if (billingPrinterCharacters['printerSize'] == '80') {
        ...
        billBytes += generator.row([
          PosColumn(
            text: "BILL NO: ${billNumberForPrint}",
            width: 6,
            styles: PosStyles(align: PosAlign.left),
          ),
          PosColumn(
        ...
        billBytes += generator.text("BILL NO: ${billNumberForPrint}",
            styles: PosStyles(
                height: PosTextSize.size1,
                width: PosTextSize.size1,
                align: PosAlign.left));
              ...
              return ListTile(
                onLongPress: () {
                  ...
                  if (printData['gstcodeforprint'] != null) {
                    localGstCodeForPrint = printData!['gstcodeforprint'];
                  }

                  localphoneNumberForPrint = printData!['phoneNumberForPrint'];
                  localaddressLine1ForPrint =
                  ...
                  localpriceOfEachDistinctItemWithoutTotalForPrint =
                      printData!['priceOfEachDistinctItemWithoutTotalForPrint'];
                  localtotalQuantityForPrint =
